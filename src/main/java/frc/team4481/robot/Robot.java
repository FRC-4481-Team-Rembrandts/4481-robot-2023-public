...
//            new Spindexer(),
  ...
  private void preloadPaths() {
    ...
    trajectoryHandler.preloadTrajectory("CABLE_COLLECT_CUBE_1");
    trajectoryHandler.preloadTrajectory("CABLE_SCORE_CUBE_1");
    trajectoryHandler.preloadTrajectory("CABLE_COLLECT_CUBE_2");
    trajectoryHandler.preloadTrajectory("CABLE_SCORE_CUBE_2");
  }
