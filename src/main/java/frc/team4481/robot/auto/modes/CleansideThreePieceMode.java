 ...
 */
@AutoMode(displayName = "[Clean] 3 Piece Score")
public class CleansideThreePieceMode extends AutoModeBase {
    double startTime;
    double previousTime;
    ...
    String path4 = "Z_CABLE_SCORE_CUBE_2_CLEANSIDE";
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        if (DriverStation.getAlliance() == DriverStation.Alliance.Red){
            ...
            path4 = "Z_CABLE_SCORE_CUBE_2_FLIPPED_CLEANSIDE";
        }
