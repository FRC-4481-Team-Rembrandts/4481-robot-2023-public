...
public class AutoModeSelector {
            ...
            throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException
    {
        ...
        for (Class<? extends AutoModeBase> currentModeClass : autoModes) {
            if (
                    currentModeClass.isAnnotationPresent(AutoMode.class) &&
                            !currentModeClass.isAnnotationPresent(Disabled.class) &&
                            (currentModeClass.getAnnotation(AutoMode.class).alliance() == DriverStation.getAlliance() ||
                            currentModeClass.getAnnotation(AutoMode.class).alliance() == DriverStation.Alliance.Invalid)
            ) {
